                        ...
                        <tbody>
                            <tr>
                                <td class="product-col">
                                    <img src="images/beli/seragam_merah.png" alt="">
                                    <div class="p-title">
                                        <h5>Kemeja Telkom University</h5>
                                    </div>
                                </td>

                                <td class="price-col">Rp 90.800</td>
                                    ...
                                    <div class="total-table">
                                        <table>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="total">Rp 90.800</td>
                                                    <td class="sub-total">Rp 90.800</td>
                                                    <td class="shipping">Rp 10.000</td>
                                                    <td class="total-cart-p">Rp 100.800</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
